...
df23_cols_old <- c("MSC_Charge", 
                    ...
                    "Latest_Arrest_Program_Current", 
                    "Latest_Arrest_Program_Current_Code")
...
df23_cols_new <- c("Most_Serious_Criminal_Conviction", 
                    ...
                    "Latest_Arrest_Program", 
                    "Latest_Arrest_Program_Code")
...
venn_23_1a <- merge_23_1$venn_after

# Merges for df231 and df4
venn_231_4 <- inspect_columns(names(df231), names(df4))
df_final <- bind_rows(df231, df4)

# write out feather file
write_feather(df_final, "data/ice-processed/removals-merged.feather")
